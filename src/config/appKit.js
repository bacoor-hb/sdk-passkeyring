...
// import { PasskeyProviderJS } from "sdk-v2-meteornrun"; // used for version <2.6.0
import { createPasskeyProvider } from "sdk-v2-meteornrun"; // used for version >= 2.6.0
...
// supported networks by sdk-v2-meteornrun: mainnet, optimism, bsc, polygon, arbitrum
