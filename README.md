# sdk-v2-egglepasskeywallet-decard JavaScript

This repository provides example of how to integrate and use **sdk-v2-egglepasskeywallet-decard** in **Javascript**. This example is designed to demonstrate best practices and simplify the integration process.

> We recommend using [Vite](https://vitejs.dev/guide/#scaffolding-your-first-vite-project) to get started with sdk-v2-egglepasskeywallet-decard JavaScript.
...
**Installation sdk-v2-egglepasskeywallet-decard package version >=2.4.28**
```
yarn add sdk-v2-egglepasskeywallet-decard@2.4.28
```
> In this example we're using package `sdk-v2-egglepasskeywallet-decard@2.4.28`

**Pleae note that sdk-v2-egglepasskeywallet-decard supports the following chains**
```
Ethereum:         '0x1'
OP Mainnet:       '0xa'
...
import { PasskeyProviderJS } from "sdk-v2-egglepasskeywallet-decard";
...
