...
**Installation sdk-v2-meteornrun package version >=2.4.28**
```
yarn add sdk-v2-meteornrun@2.4.28
```
> In this example we're using package `sdk-v2-meteornrun@2.4.28`
