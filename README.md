# sdk-v2-keyringpasskeywallet JavaScript

This repository provides example of how to integrate and use **sdk-v2-keyringpasskeywallet** in **Javascript**. This example is designed to demonstrate best practices and simplify the integration process.

> We recommend using [Vite](https://vitejs.dev/guide/#scaffolding-your-first-vite-project) to get started with sdk-v2-keyringpasskeywallet JavaScript.
...
import { PasskeyProviderJS } from "sdk-v2-keyringpasskeywallet";
...
...
## Trigger the modal
> Add `<appkit-button>` and `<passkey-provider />` to your html file and load your javacript file here
...
## How to run this example app at your local?
1. Clone source
