...
**Installation sdk-v2-meteornrun-decard package version >=2.4.28**
```
yarn add sdk-v2-meteornrun-decard@2.4.28
```
> In this example we're using package `sdk-v2-meteornrun-decard@2.4.28`

**Pleae note that sdk-v2-meteornrun-decard supports the following chains**
```
Ethereum:         '0x1'
OP Mainnet:       '0xa'
