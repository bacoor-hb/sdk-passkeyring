# sdk-v2-cyberstepwallet JavaScript

This repository provides example of how to integrate and use **sdk-v2-cyberstepwallet** in **Javascript**. This example is designed to demonstrate best practices and simplify the integration process.

> We recommend using [Vite](https://vitejs.dev/guide/#scaffolding-your-first-vite-project) to get started with sdk-v2-cyberstepwallet JavaScript.
...
**Installation sdk-v2-cyberstepwallet package version >=2.5**
```
yarn add sdk-v2-cyberstepwallet@^2.5
```

**Pleae note that sdk-v2-cyberstepwallet supports the following chains**
```
Ethereum:         '0x1'
OP Mainnet:       '0xa'
...
import { PasskeyProviderJS } from "sdk-v2-cyberstepwallet";
...
